...
const CreateList = () => {
  ...
  const handleMailList = async () => {
    ...
    setTimeout(()=>{
      navigate(`/mapping/${newList.data._id}`);
    }, 2000)
    } catch (error) {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      <div className="mt-6 flex items-center gap-4">
        <label className="flex items-center gap-2 cursor-pointer">
          <input type="radio" name="fileOption" value="csv" defaultChecked className="hidden" />
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          <input type="radio" name="fileOption" value="sheet" className="hidden" />
          <span className="w-4 h-4 border rounded-full flex items-center justify-center">
      ...
      <div className="mt-4 flex gap-4">
        <button
          ...
          disabled={!file || !listName} // Disable if no file or list name
        >
          Next
        </button>
        <button
